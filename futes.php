...
<header class='mainHeader1'>
    <div class='container'>
        <div class='animatedParent' data-sequence='500' >
            <h1 class='animated growIn slower'  data-id='1' style="color: darkred">Fűtésszerelés</h1>
            <h2 class='animated bounceInRight slower'  data-id='2' style="color: #FFFFFF">Kérje árajánlatunkat</h2>
            <h1 class="animated bounceInLeft slower" data-id='1' ><a href="levelezes.php"style="color: red">Levelezés
            </a> </h1>
        </div>
    </div>
</header>
...
<div class='container'>
    <div class='animatedParent'>
        <h2 class='animated growIn slowest'>Kezdődik</h2>
    </div>
    <div class='animatedParent col-md-6' data-sequence='1000'  style="color: #5f5f5f">

        <p class='animated growIn slowest' data-id="1">Építőipari panaszmentességi igazolás</p>

    </div>
    <div class='animatedParent col-md-6' data-sequence='1000'  style="color: #5f5f5f">


        <p class='animated bounceInLeft' data-id='3'>Bemutatkozás</p>
    </div>
    ...
    <div class='animatedParent col-md-6' style="color: #5f5f5f; height: 400px">
<pre class='animated bounceInRight slow'>
    <?php echo htmlspecialchars("<div class='animatedParent' "); ?><span class='highlighter'><?php echo
        htmlspecialchars("data-sequence='500'") ?></span><?php echo htmlspecialchars(">Fusce dapibus, tellus ac cursus commodo</h2>"); ?>

    <?php echo htmlspecialchars("<h2 class='animated bounceInDown' "); ?><span class='highlighter'><?php echo htmlspecialchars("data-id='2'"); ?></span><?php echo htmlspecialchars(">Fusce dapibus, tellus ac cursus commodo</h2>"); ?>
...
<div class='container'>
    ...
    <div class='animatedParent col-md-6' data-sequence='1000'  style="color: #5f5f5f">
        <p class='animated bounceInLeft' data-id='1' style="color: #5f5f5f">
            Include <a href='css3-animate-it-master/js/css3-animated.js' style="color: #5f5f5f">css3-animated.js</a> at the end of your file and <a href='css3-animate-it-master/css/animations.css'style="color: #5f5f5f">animations.css</a> in the head.
        </p>
    ...
    <div class='animatedParent col-md-6' style="color: #5f5f5f">
<pre class='animated bounceInRight slow'>
...
<?php echo htmlspecialchars("<div class='animatedParent' "); ?><span class='highlighter'><?php echo htmlspecialchars("data-sequence='500'") ?></span><?php echo htmlspecialchars(">") ?>
    ...
    <?php echo htmlspecialchars("</div>"); ?>
        ...
        <div class='animatedParent row article'>
            ...
            <div class='col-md-6' style="color: #5f5f5f">
                <p class='animated bounceInLeft slow'>
...
<?php echo htmlspecialchars("<div class='animatedParent'"); ?><span class='highlighter'><?php echo htmlspecialchars("data-appear-top-offset='-300'") ?></span><?php echo htmlspecialchars(">") ?>
    ...
    <?php echo htmlspecialchars("</div>"); ?>
        ...
        <div class='animatedParent row article'>
            ...
            <div class='col-md-6'>
                <p id="test" class='animated bounceInLeft slow'>
