...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img  src="image/falvagas1.jpg" alt="FODIN-HOME KFT">
        </div>

        <div class="item">
            <img src="image/falvagas2.jpg" alt="FODIN-HOME KFT ">
        </div>

        <div class="item">
            <img  src="image/falvagas3.jpg" alt="FODIN-HOME KFT">
        </div>
...
<div class="container">
    ...
    <table class="table table-hover">
        <thead>
        <tr>
            <th style="color: red">Speciális falvágások</th>
        </tr>
        </thead>
        <tbody>
        <tr>
            <td style="background-color: #3f3f3f; color: red;" >Falkivágás családi házakban<br>

                Statikai szempontok szerint
                - Térelvélasztók és azok meghatározása
                - Merevítő szerkezetek
                - Panelfal vágás
                - Falkivágás családi házakban
                - Falkivágás ipari épületekben
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">A falvágásról</h4>
                </div>
                <div class="modal-body">
                    <div style="text-align: center; width: auto; height: auto">
                        <img src="image/falvagas4.jpg" title="A falvágásról" alt="falvagas4.jpg" height="300"
                             width="302">
                    </div>
                    <h6><br>- Betonvágás<br>
                        - Gyémánttechnológia<br>
                    </h6>
                </div>
    ...
    <div class="modal fade" id="myModal1" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Új nyílások vágása</h4>
                </div>
                <div class="modal-body">
                    <div style="text-align: center; width: auto; height: auto">
                        <img src="image/falvagas5.jpg" title="Bontási munkálatok" alt="falvagas5.jpg" height="300"
                             width="302">
                    </div>
    ...
    <div class="modal fade" id="myModal2" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Speciális falvágások</h4>
                </div>
                <div class="modal-body">
                    <div style="text-align: center; width: auto; height: auto">
                        <img src="image/falvagas6.jpg" title="GIPSZKARTON PROFIL" alt="falvagas6.jpg" height="300"
                             width="302">
                    </div>
        ...
        <div class='col-md-4'>
            <p class='animated bounceInDown slow'>
                <div class="thumbnail animated bounceInDown slow">
                    <img src="image/falvagas7.jpg" alt="falvagas7.jpg" height="300" width="302">
    ...
    <div class='col-md-4'>
        <p class='animated bounceInUp slow'>
            <div class="thumbnail animated bounceInUp slow">
                <img src="image/falvagas8.jpg" alt="falvagas8.jpg" height="300" width="302">
...
<div class='col-md-4'>
    <p class='animated bounceInDown slow'>
        <div class="thumbnail animated bounceInDown slow">
            <img src="image/falvagas9.jpg" alt="falvagas9.jpg" height="300" width="302">
    <p style="color: #5e5e5e; text-align: center"><strong >Bontási munkálatok, lakások, épületek bontása!</strong></p>
    <p style="color: #5e5e5e; text-align: center">Bontási munkálatok, lakások, épületek bontása!</p>
    <div class="buttonHolder">
