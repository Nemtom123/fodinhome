...
<div class="container-fluid" style="margin-top:80px;">
    ...
    <div class="container">
        ...
        <h4>
            ...
            <a href="anyagmodosit.php"><span class="glyphicon glyphicon-apple" > Modosítás</span></a>
            <a href="anyagtorol.php"> <span class="glyphicon glyphicon-bed" style="color: #9acfea"> Törlés</span></a>
        </h4>
    </div>
</div>
<div class="clearfix"></div>
...
<form method="post" class="media" name="jav">
            ...
            try
            {
                ...
                else
                {
                    if($torol->megnevezesTorol($megnevezes_id)) {
                        $torol->redirect('anyagtorol.php?joined');
    ...
    <div class="container">
        ...
        <div class="container">
            <button class="btn-danger" name="btn-rogzit" value=":<?php echo  $ujsor['megnevezes']; ?>" onkeyup="frissites()"
