...
<div class="container">
    ...
    <table class="table table-hover">
        <thead>
        <tr>
            <th style="color: red">Központi fűtés szöveg</th>
        </tr>
        </thead>
        <tbody>
        <tr>
            <td style="background-color: #3f3f3f">Központi fűtés szöveg </td>
        </tr>
        </tbody>
    </table>
    <script>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Központi fűtés szöveg</h4>
                </div>
                <div class="modal-body">
                    ...
                    <h6><br>Központi fűtés szöveg<br>
                        - Központi fűtés szöveg<br>
                    </h6>
                </div>
    ...
    <div class="modal fade" id="myModal2" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Központi fűtés</h4>
                </div>
                <div class="modal-body">
                    <div style="text-align: center; width: auto; height: auto">
                        <img src="image/gipsz613.jpg" title="GIPSZKARTON PROFIL" alt="Smiley face" height="300" width="302">
                    </div>
                    <h6 style="color: #3f3f3f"><br>Központi fűtés szöveg<br>
                        - Központi fűtés szöveg<br>
                    </h6>
                </div>
                <div class="modal-footer">
    ...
    <div class='animatedParent row article'>
        <h3 class='animated bounceInDown'>Központi fűtés szöveg</h3>
        <div class='col-md-4'>
            ...
            <p style="color: #5e5e5e;text-align: center"><strong >Központi fűtés szöveg</strong></p>
            <p style="color: #5e5e5e; text-align: center">Központi fűtés szöveg</p>
...
<table class="table table-hover">
    ...
    <tbody>
    <tr>
        <td style="background-color: #3f3f3f">Központi fűtés szöveg
        </td>
    </tr>
    </tbody>
</table>
...
<footer class="footer"  style="background-color: #FFFFFF">
    <div class="text-center" style="background-color:#FFFFFF " >
        <a class="up-arrow" href="kozponti.php" data-toggle="tooltip" title="TO TOP">
