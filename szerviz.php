...
<div class="container">
    ...
    <table class="table table-hover">
        <thead>
        <tr>
            <th style="color: #5f5f5f">Gázos</th>
            <th style="color: #5f5f5f; alignment: center">Ügyeletes</th>
        ...
        <tr>
            <td>
                <img src="image/KirályGábor.jpg" alt="Király Gábor" style="size: 10px"><br><br>
                <p style="color: #5f5f5f">Király Gábor</p>
    ...
    <table class="table table-hover">
        <thead>
        <tr>
            <th style="color: #5f5f5f">Ügyeletes</th>
            <th style="color: #5f5f5f">Víz</th>
        ...
        <tr>
            ...
            <td>
                <img src="image/NagyIstvan.jpg" alt="Nagy István" style="size: 10px"><br><br>
                <p style="color: #5f5f5f">Nagy István</p>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-hover">
        <thead>
        <tr>
            <th style="color: #5f5f5f">Villany</th>
            <th style="color: #5f5f5f; alignment: center">Ügyeletes</th>
        ...
        <tr>
            <td>
                <img src="image/OsváthTibi.jpg" alt="Osváth Tibor" style="size: 10px"><br><br>
                <p style="color: #5f5f5f">Osváth Tibi</p>

            </td>
            <td style="color: #5f5f5f">szöveg</td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-hover">
        <thead>
        <tr>
            <th style="color: #5f5f5f">Bemutatkozás</th>
