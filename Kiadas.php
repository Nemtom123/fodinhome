...
class Kiadas
{
    ...
    public function kiadasRogzit($megrendelo_id, $termek_id, $mennyiseg, $kiadasi_ido)
    {
        try {
            $kiadas = $this->kapcsolodas->prepare("INSERT INTO termekkiadas (megrendelo_id,termek_id,mennyiseg,kiadasi_ido	) 
            VALUES(:megrendelo_id,:termek_id,:mennyiseg,:kiadasi_ido)");
